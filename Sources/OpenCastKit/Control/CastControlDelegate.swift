...
public protocol CastControlDelegate: AnyObject {
    ...
    func castControl(_ client: CastControl, activeAppDidChange app: ReceiverApp?)
    
    func castControl(_ client: CastControl, deviceStatusDidChange status: ReceiverStatus)
